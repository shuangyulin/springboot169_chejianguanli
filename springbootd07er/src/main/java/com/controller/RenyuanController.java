...
public class RenyuanController {
    ...
    public R register(@RequestBody RenyuanEntity renyuan){
    	...
    	RenyuanEntity user = renyuanService.selectOne(new EntityWrapper<RenyuanEntity>().eq("zhanghao", renyuan.getZhanghao()));
		if(user!=null) {
    ...
    public R query(RenyuanEntity renyuan){
		...
		return R.ok("查询人员成功").put("data", renyuanView);
    }
    ...
    public R update(@RequestBody RenyuanEntity renyuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(renyuan);
        renyuanService.updateById(renyuan);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<RenyuanEntity> wrapper = new EntityWrapper<RenyuanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = renyuanService.selectCount(wrapper);
